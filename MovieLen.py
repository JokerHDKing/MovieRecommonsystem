...
class MovieLen(object):
    def __init__(self):
        # 声明每个数据文件的路径
        usr_info_path = "flask/templates/work/ml-1m/users.dat"

        rating_path = "flask/templates/work/ml-1m/ratings.dat"

        movie_info_path = "flask/templates/work/ml-1m/movies.dat"
